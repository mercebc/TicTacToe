...
//gets the spot near the spot i
  private int getNextSpot(int i, Player opponent, List<String> currentList, List<String> otherList, List<String> corner, List<String> edge, List<Integer> availableSpaces){
    switch (i) {
      case 0:
        for (int j = 0; j < 2; j++) {
  ...
  private int getSpotMapping(int i,List<String> mappingList, List<String> corner, List<String> edge) {
